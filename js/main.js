    ...
    function() {
        ...
        document.addEventListener("DOMContentLoaded", b, !1),
            ...
            a.trim = function(a) {
                ...
                for (;;) {
                    if (0 !== a.indexOf(" ")) break;
                    a = a.substring(1, a.length)
                }
                for (;;) {
                    if (a.lastIndexOf(" ") !== a.length - 1) break;
            ...
            a.addClass = function(b, c) {
                ...
                for (var e = 0; e < d.length; e++)
                    for (var f = d[e], g = f.className.split(" "), h = c.split(" "), i = 0; i < h.length; i++) {
                        var j = h[i];
                        a.hasContain(g, j) === !1 && (f.className += " " + j)
                    }
            },
            a.removeClass = function(b, c) {
                ...
                for (var e = 0; e < d.length; e++)
                    for (var f = d[e], g = c.split(" "), h = 0; h < g.length; h++) {
                        var i = g[h];
                        f.className = a.trim(f.className.replace(i, ""))
                    }
            };
    ...
    var a, b, c, d, e, f = 25,
        ...
        p = function() {
            ...
            var e = document.documentElement.clientWidth,
                f = (document.documentElement.clientHeight) * 8 / 10;
            a.style.width = e + "px", a.style.height = f + "px", c = a.width = e, d = a.height = f, q(k), a.onmousemove = y, a.ontouchstart = A, a.ontouchmove = B, a.ontouchend = C, window.onresize = z, window.onorientationchange = z, r()
        },
        q = function(a) {
        ...
        r = function() { m || (t(), u(), o(r, 1e3 / f)) },
        s = function() { m = !0 },
        t = function() { b.clearRect(0, 0, c, d), e && e.draw() },
        u = function() { e && e.update() },
        v = function(a, b, c) { this.x = a, this.y = b, this.z = c || 1 },
        w = function(a) {
        ...
        x = function(a, c, d, e, f) {
            ...
            this.orgnPos = new v(a, c, d), this.curPos = new v(a, c, d), this.targetPos = new v(a, c, d), this.radius = e / 3, this.size = e / 3, this.friction = g, this.rotationForce = h, this.springStrength = i, this.velocity = new v(0, 0, 0), f = void 0 === f ? 1 : f, this.color = "rgba(10,0,23," + f + ")", this.update = function() {
                    ...
                    this.velocity.x += c, this.velocity.x *= this.friction, this.curPos.x += this.velocity.x, this.velocity.y += d, this.velocity.y *= this.friction, this.curPos.y += this.velocity.y;
                    ...
                    this.velocity.z += j, this.velocity.z *= this.friction, this.curPos.z = this.velocity.z, this.radius = this.size * this.curPos.z, this.radius < 1 && (this.radius = 1)
                },
                //ここで描画しているっぽい！！
                this.draw = function() { b.fillStyle = this.color, b.beginPath(), b.arc(this.curPos.x, this.curPos.y, this.radius, 0, 2 * Math.PI), b.fill() }
        },
        y = function(a) { e.mousePos = new v(a.offsetX, a.offsetY) },
        z = function() { e = null, p() },
        A = function(a) { a.preventDefault() },
        B = function(a) { a.preventDefault(), e.mousePos = new v(a.targetTouches[0].pageX, a.targetTouches[0].pageY) },
        C = function(a) { a.preventDefault(), e.mousePos = new v(0, 0) };
    p(), window.nuru.onloadEvents.push(p), window.nuru.startTopAnimation = p, window.nuru.stopTopAnimation = s
}();